...
namespace Engine
{
    public class Player : LivingCreature
    {
        ...
        // track the player's current location in the game world
        public Location CurrentLocation { get; set; }

        // need a way to track items and quests while playing
        ...
        public Player(int currentHitPoints, int maximumHitPoints, int gold, int experiencePoints, int level) : base(currentHitPoints, maximumHitPoints)
        {
            ...
            // sets the value of the new properties to empty lists, can add items later
            // NOTE: you can add objects to an "empty list" but not to "nothing" (null)
            Inventory = new List<InventoryItem>();
            Quests = new List<PlayerQuest>();
        }

        // pass in the location and see if the player can move there
